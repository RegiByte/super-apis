...
import { ChevronDownIcon, RectangleStackIcon } from "@heroicons/react/20/solid";
...
const apps = [
  {
    ...
    description: "App para armazenar tarefas",
    href: "/todos",
    icon: RectangleStackIcon,
  },
];
const callsToAction = [
  { name: "Botão 1", href: "#", icon: PlayIcon },
  { name: "Botão 2", href: "#", icon: PhoneIcon },
];
